...
After installing BLAST+ and obtaining UniRef100, update your local SAAFEC-SEQ configuration so it points to the `psiblast` binary directory and the UniRef100 database directory.
